...
ちょうちょう: butterfly (noun)
            ...
            そら: sky (noun)
              へ: to (directional pointer)
                と: exclusive and
                  のぼる: climb (verb)
                  のぼれ: (commanding verb)

butterfly, to + sky + climb
```
```
...
自由 (じゆう): freedom (noun)
思: mind
じゆういし: free will (freedom + mind) (noun)
          せんたく: choice/selection (noun)

                  さずかる: receive award/blessed with (verb)
...
```
すべて: everything (noun)
    さだめる: decide/determine/bring peace to (ichidan verb)
    さだめられた: decided smth (past receptive verb)

                  あらかじめ: beforehand/previous (noun)
                  さだめる: determine/decide (ichidan verb)
                  しらべる: tone/key(music)
                  やわらぐ: harmony/peace
                  よていちょうわ: pre-established harmony (noun)
                            ことわり: logic/reason
                            おもう: thought/idea
...
与えられた　真実が
```
あたえる: give/bestow (ichidan verb)
与えられた: gave/granted (past receptive verb)
...
ロールプレイ: roleplay
              ...
              繰り返す: repeat
                      てん: heaven (noun)
                      ち: earth (noun)
                      天地: nature (heaven and earth)

                            その: that
                                はこ: box/chest (noun)
                                にわ: garden (noun)
                                箱庭: miniature garden (noun)
                                      かぎ: key (noun)
...
いつまで: until when
人: human (noun)
いられる: exist (receptive/get to live) (ichidan verb)

                        この: this
                            因果: karma (noun)
                                  うえ: above (noun)
                                  上で: position/location pointer で
...
```
いつ: one
いつの日か: one of these days
に: date pointer (particle)
...
```
いく: go (verb)
行き: go and (verb compound connector き)
    つく: arrive/reach (verb)
        さき: before/ahead
            なに: what
            ところ: place
            どこ: where
                だって: but (argument/objection demeanor)

                        あたえる: grant (ichidan verb)
                        与えられた: was granted (receptive past tense verb)
                                  みち: way/road (noun)
                                  　いきる: live (verb)
      ...
      で: copula form of だ
        ある: exist/be (verb)
            うち: among (noun)
                    ...
                    すき: like/love (noun)
                          する: make (other-move verb)
                          させる: to/can make (causative verb)
                          させない: can't make (negative causative verb)
                                  からね
